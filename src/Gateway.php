...
class Gateway extends Core_Gateway {
	...
	public function __construct( Config $config ) {
		...
		$this->register_payment_method( new PaymentMethod( PaymentMethods::ONLINE_BANKING_CZ ) );
		$this->register_payment_method( new PaymentMethod( PaymentMethods::ONLINE_BANKING_SK ) );
